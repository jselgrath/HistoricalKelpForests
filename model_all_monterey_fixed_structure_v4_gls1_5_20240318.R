...
a1
write_csv(a1,"./doc/table_SI10_kelpcover_yearlocationottersenso_anovatable.csv")
...
a2
write_csv(a2,"./doc/table_SI10_model_all_mont_yearlocation_coefficents_20240318.csv")
