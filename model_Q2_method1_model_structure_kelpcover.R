...
fxn3<-formula(kelp_maxarea_p ~ Location*otter_period) 
fxn4<-formula(kelp_maxarea_p ~ Location+otter_period)

# two variables, otter_period, year
fxn5<-formula(kelp_maxarea_p ~ otter_period*Location+yr_after_enso1_5) 
fxn6<-formula(kelp_maxarea_p ~ otter_period*Location+yr_after_enso1_5)

# two variables, Location, year
fxn7<-formula(kelp_maxarea_p ~ year*Location) 
fxn8<-formula(kelp_maxarea_p ~ year+Location)

#single variables
fxn9<-formula(kelp_maxarea_p ~ otter_period)
fxn10<-formula(kelp_maxarea_p ~ Location)
fxn11<-formula(kelp_maxarea_p ~ year)

# intercept
fxn12<-formula(kelp_maxarea_p ~ 1)
...
plot(m3,main="m3") # kelp_maxarea_p ~ Location*otter_period
