...
#===================================================
# set analysis variance structure ######
#===================================================
...
m1<-gls(fxn1,  varr, method="ML", data=d1)
m2<-gls(fxn2,  varr, method="ML", data=d1)
m3<-gls(fxn3,  varr, method="ML", data=d1)
m4<-gls(fxn4,  varr, method="ML", data=d1)
m5<-gls(fxn5,  varr, method="ML", data=d1)
m6<-gls(fxn6,  varr, method="ML", data=d1)
m7<-gls(fxn7,  varr, method="ML", data=d1)
m8<-gls(fxn8,  varr, method="ML", data=d1)
m9<-gls(fxn9,  varr, method="ML", data=d1)
m10<-gls(fxn10,varr, method="ML", data=d1)
m11<-gls(fxn11,varr, method="ML", data=d1)
m12<-gls(fxn12,varr, method="ML", data=d1)
m13<-gls(fxn13,varr, method="ML", data=d1)
m14<-gls(fxn14,varr, method="ML", data=d1)
m15<-gls(fxn15,varr, method="ML", data=d1)
m16<-gls(fxn16,varr, method="ML", data=d1)
m17<-gls(fxn17,varr, method="ML", data=d1)
m18<-gls(fxn18,varr, method="ML", data=d1)
m19<-gls(fxn19,varr, method="ML", data=d1)
m20<-gls(fxn20,varr, method="ML", data=d1)
m21<-gls(fxn21,varr, method="ML", data=d1)
m22<-gls(fxn22,varr, method="ML", data=d1)
m23<-gls(fxn23,varr, method="ML", data=d1)
m24<-gls(fxn24,varr, method="ML", data=d1)
m25<-gls(fxn25,varr, method="ML", data=d1)
m26<-gls(fxn26,varr, method="ML", data=d1)
m27<-gls(fxn27,varr, method="ML", data=d1)
m28<-gls(fxn28,varr, method="ML", data=d1)
m29<-gls(fxn29,varr, method="ML", data=d1)
m30<-gls(fxn30,varr, method="ML", data=d1)
m31<-gls(fxn31,varr, method="ML", data=d1)
m32<-gls(fxn32,varr, method="ML", data=d1)
m33<-gls(fxn33,varr, method="ML", data=d1)
...
# save final model
#===================================================
save(mFinal,file="./results/model_kelpcover_yearlocationottersenso_nocorr.rda")
...
a1
write_csv(a1,"./doc/model_kelpcover_yearlocationottersenso_anovatable_nocorr.csv")
...
a2
write_csv(a2,"./doc/model_kelpcover_yearlocationsottersenso_coefficents_nocorr.csv")
