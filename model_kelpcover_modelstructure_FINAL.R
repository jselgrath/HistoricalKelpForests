...
fxn1<-formula(kelp_area_p ~ year*Location*otter_period)
fxn2<-formula(kelp_area_p ~ year*Location+otter_period)
fxn3<-formula(kelp_area_p ~ year+Location*otter_period)
fxn4<-formula(kelp_area_p ~ year+Location+otter_period)

# two variables, Location, otter_period
fxn5<-formula(kelp_area_p ~ Location*otter_period) 
fxn6<-formula(kelp_area_p ~ Location+otter_period)

# two variables, otter_period, year
fxn7<-formula(kelp_area_p ~ year*otter_period) 
fxn8<-formula(kelp_area_p ~ year+otter_period)

# two variables, Location, year
fxn9<-formula(kelp_area_p ~ year*Location) 
fxn10<-formula(kelp_area_p ~ year+Location)

#single variables
fxn11<-formula(kelp_area_p ~ otter_period)
fxn12<-formula(kelp_area_p ~ Location)
fxn13<-formula(kelp_area_p ~ year)

# intercept
fxn14<-formula(kelp_area_p ~ 1)
...
plot(m5,main="m5") # kelp_area_p ~ Location*otter_period
...
# Final 5: kelp_area_p ~ Location*otter_period
...
a1
write_csv(a1,"./doc/model_kelpcover_yearlocationottersenso_anovatable.csv")
...
a2
write_csv(a2,"./doc/model_kelpcover_yearlocationsottersenso_coefficents.csv")
