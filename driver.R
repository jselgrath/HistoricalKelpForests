...
#         ./gis/kelp_maps_2024/extent_historical_map.gpkg
...
# input:    ./data/kelp_historical_expanded_20230612.csv
# output:   ./results/kelphistorical_expanded_clean.csv

source("./bin/kelp_historical_orgainze.R")
# input:    ./results/kelphistorical_expanded_clean.csv
...
# input:  ./data/PacificGrove_TEMP_1919-202112_NoMetadata.csv
...
# input:  ./data/urchins_historical_20240308b.csv
...
#             ./data/otter_cdfw_dens_0-30m_location3.csv
...
# input:  ./data/MLPA_kelpforest_swath.4.csv
#         ./resultsPISCO_MLPA_transects_site_year.csv               # location data
#         ./results/PISCO_MLPA_site_year.csv")  # lat/long data
# output: ./results/pycno_PISCO_location123.csv
...
# output: ./results/all_var_location_2024_interpol_allyr.csv
...
source("./bin/model_kelpcover_correlation4_otterperiod_2024.R") 
...
# table S9
source("./bin/model_kelpcover_modelstructure_FINAL_2024.R")
# input:    ./results/alldata_kelpcover_otter-enso_location3.csv
...
# Figure 3c - 1826-2020
source("./bin/graph_fig3c_ensorecoverylag_FINAL.R")
