...
d5$organism<-"red urchin"
d5

unique(d5$organism)

write_csv(d5,"./results/urchin_red_contemporary_density_transect.csv")
...
d6
write_csv(d6,"./results/urchin_red_contemporary_density_location.csv")
...
d7
write_csv(d7,"./results/urchin_red_contemporary_density_location3.csv")
...
d8
write_csv(d8,"./results/urchin_red_contemporary_density_allsites.csv")
...
d9
write_csv(d9,"./results/urchin_red_contemporary_density_allsitesyears.csv")
...
source("./bin/deets.R")
ggplot(d7,aes(x=year,y=density_m2_u,color=location3))+geom_line()+deets3
...
d0p<-filter(d9,genus=="Mesocentrotus")
dens_0<-0
...
write_csv(d10,"./results/urchin_red_contemporary_abundance_location.csv")
write_csv(d11,"./results/urchin_red_contemporary_abundance_location3.csv")
